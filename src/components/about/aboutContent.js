...
export const ABOUT_CONTENT = {
    site: {
        ...
        criteria: [
            ...
            "電子遊戲僅收錄可以確認為台灣本土團隊製作的作品，且不包括大型電玩。",
        ],

        notices: [
            "網站資料皆為人工彙整，可能因來源落差或更新時間而存在錯誤。若您發現資料有誤或遺漏，歡迎進行 [網站回報] 。",
            "作品名稱、劇照、海報、商標及其他相關權利均屬其原權利人所有。本站僅於合理範圍內作介紹與推廣使用，若有侵權請於 [網站回報] 告知，將立即下架。",
        ],
    },
    ...
    author: {
        ...
        paragraphs: [
            ...
            "各大影音、影評、百科或資料庫所中包含的台灣作品資料往往不完整，這讓大眾只能在各處找到零散的資訊，常常忽略了許多本土的優秀創作，讓我感到非常可惜。",
            ...
            "然而我很快意識到，單靠依靠Youtube的播放清單並不足以提供完整的資料列表、資料和搜尋功能，因此我決定進一步，使用試算表來進行整理，並自學網頁開發來視覺化呈現這些資料。",

            "本計劃從2023年開始至今，從網頁開發到資料蒐集，完全由我自己一個人利用課餘時間完成，因此資料更新、功能新增與錯誤修正都需要時間，還請多多包涵與支持。",
        ],
    },
